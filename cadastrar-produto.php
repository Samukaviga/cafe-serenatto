<?php
        ...
        if(isset($_POST['cadastro'])){
            ...
            $preco = $_POST['preco'];
            //$imagem = ($_POST['imagem']) ? $imagem = $_POST['imagem'] : $imagem = "";
        

                $produto = new Produto(null, $tipo, $nome, $descricao, $preco);

                if($_FILES['imagem']){

                    $produto->setImagem(uniqid($_FILES['imagem']['name']));

                    var_dump($produto->getImagemFormatada());
                    
                    move_uploaded_file($_FILES['imagem']['tmp_name'], $produto->getImagemFormatada());

                } 

            $cadastrado = $produtoRepositorio->cadastrarProduto($produto);
